...
<html lang="en">
  ...
  >
    ...
    >
      ...
      <p>
        We're excited to have you join our messaging platform! Circle connects
        you with friends, family, and colleagues in real-time, no matter where
        they are.
      </p>
      ...
      <p style="margin-top: 25px; margin-bottom: 0">
        Best regards,<br />The Circle Team
      </p>
    </div>
    ...
    >
      ...
      <p>
        <a
          href="#"
          style="color: #5b86e5; text-decoration: none; margin: 0 10px"
          >Privacy Policy</a
        >
        <a
          href="#"
